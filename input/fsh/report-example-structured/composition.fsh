...
* section[findings]
  ...
  * entry[image][+] = Reference (StructuredKeyImageRestR4)
  * entry[image][+] = Reference (StructuredKeyImageStressR4)
//R5  * entry[image][+] = Reference (StructuredKeyImageRest)
//R5  * entry[image][+] = Reference (StructuredKeyImageStress)
// /////////////////// IMPRESSION SECTION //////////////////////////
* section[impression]
  * title = "Impression"
