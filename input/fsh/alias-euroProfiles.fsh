...
Alias: $EuAllergyIntolerance    = http://hl7.eu/fhir/base/StructureDefinition/allergyIntolerance-eu-core
Alias: $EuAllergyIntoleranceUrl = http://hl7.eu/fhir/base/StructureDefinition/allergyIntolerance-eu-core
...
Alias: $EuCondition            = http://hl7.eu/fhir/base/StructureDefinition/condition-eu-core
Alias: $EuConditionUrl         = http://hl7.eu/fhir/base/StructureDefinition/condition-eu-core
...
Alias: $EuComposition          = http://hl7.eu/fhir/base/StructureDefinition/composition-eu-core
Alias: $EuCompositionUrl       = http://hl7.eu/fhir/base/StructureDefinition/composition-eu-core
...
Alias: $EuDiagnosticReport     = http://hl7.eu/fhir/base/StructureDefinition/diagnosticReport-eu-core
Alias: $EuDiagnosticReportUrl  = http://hl7.eu/fhir/base/StructureDefinition/diagnosticReport-eu-core
...
Alias: $EuLocationUrl          = http://hl7.eu/fhir/base/StructureDefinition/location-eu-core
//R5Alias: $EuLocation             = http://hl7.eu/fhir/base-r5/StructureDefinition/location-eu-core
//R5Alias: $EuLocationUrl          = http://hl7.eu/fhir/base-r5/StructureDefinition/location-eu-core
...
Alias: $EuProcedure            = http://hl7.eu/fhir/base/StructureDefinition/procedure-eu-core
Alias: $EuProcedureUrl         = http://hl7.eu/fhir/base/StructureDefinition/procedure-eu-core
