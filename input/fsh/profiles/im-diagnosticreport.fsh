...
* extension[DiagnosticReportCompositionR5] ^short = "Imaging Diagnostic Report"
* extension[DiagnosticReportCompositionR5].valueReference only Reference(CompositionEuImaging)
