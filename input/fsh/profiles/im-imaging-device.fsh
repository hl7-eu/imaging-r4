...
//R5-6* category contains imaging 1..1
//R5-6* category[imaging] = $sct#314789007 // "Diagnostic imaging equipment"
...
//R5-6* name -> "StationName (0008,1010) | ManufacturerModelName (0008,1090)"
